...
do
    ...
    #cufflinks
    mkdir -p ${work}/cufflinks/${file}
    $cufflinks_dir/cufflinks -p 8 -G /database/hg19/Gencode/hg19_genes.gtf --compatible-hits-norm -o ${work}/cufflinks/${file} ${work}/tophat/${file}/accepted_hits.bam
done <sample_list
   #cuffdiff
